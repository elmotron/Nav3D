...
private:
	...
	void UpdateOcclusionComponentCover(const FVector& Location, TArray<FOverlapResult>& Overlaps) const;
	...
	void DebugDrawVoxel(const FVector& Location, const FVector& Extent, FColor Colour) const;
