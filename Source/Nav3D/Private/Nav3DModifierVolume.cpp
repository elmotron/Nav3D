...
void ANav3DModifierVolume::EditorApplyTranslation(const FVector& DeltaTranslation, bool bAltDown, bool bShiftDown,
                                                  bool bCtrlDown)
{
...
void ANav3DModifierVolume::EditorApplyRotation(const FRotator& DeltaRotation, bool bAltDown, bool bShiftDown,
                                               bool bCtrlDown)
{
...
void ANav3DModifierVolume::EditorApplyScale(const FVector& DeltaScale, const FVector* PivotLocation, bool bAltDown,
...
void ANav3DModifierVolume::GetOverlappingVolumes(TArray<ANav3DVolume*>& Volumes, TArray<FBox>& Overlaps) const
{
	...
	{
		if (ANav3DVolume* Nav3DVolumeActor = Cast<ANav3DVolume>(Actor))
		{
